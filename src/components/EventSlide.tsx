...
const EventSlide: React.FC<EventProps> = ({
  ...
  return (
    <div className="flex flex-col bg-slate-900 text-white rounded-lg shadow-lg overflow-hidden h-full profiles__item  l:min-h-[500px]">
      ...
      <div className="data">
        ...
        <h2 className="text-xl font-bold my-2 text-[#D0D5DD]">{name}</h2>
